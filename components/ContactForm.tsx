      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="p-5 rounded-2xl bg-slate-50 border border-slate-200 hover:border-red-500 transition-all flex items-center gap-4 group shadow-sm hover:shadow-md"
              >
                <div className="w-12 h-12 rounded-xl bg-red-50 text-red-600 group-hover:bg-red-600 group-hover:text-white flex items-center justify-center transition-colors">
          ...
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-10 rounded-3xl bg-slate-50 border border-slate-200 shadow-lg relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm focus:border-red-600 focus:outline-none shadow-sm transition-colors"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-900 text-sm focus:border-red-600 focus:outline-none shadow-sm transition-colors resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-4 px-6 bg-red-600 hover:bg-red-700 disabled:bg-slate-400 text-white font-black text-sm uppercase tracking-wider rounded-2xl shadow-lg shadow-red-600/25 hover:shadow-xl hover:shadow-red-600/35 transition-all flex items-center justify-center gap-2"
                  >
